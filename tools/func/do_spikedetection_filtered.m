function [time_occur, out_val] = do_spikedetection_filtered(cfg, val)
...
ts_pp = (abs(hilbert((val.pow))));
% ts_pp = (abs(hilbert((val.pow(minidx1:minidx2,:)))));
