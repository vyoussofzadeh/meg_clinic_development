function configure_cfit(varargin)
% configure_cfit: callback function from MEG-Clinic, Dipole Fitting - Configure Button
%
...
hGetEventsButton = handle(setup.getMatlabCallbackButton(),'CallbackProperties');
set(hGetEventsButton, 'ActionPerformedCallback', @(h,v)fiffReadEventFile(setup.getEventFile(),setup.getEveNumModel(),1));
